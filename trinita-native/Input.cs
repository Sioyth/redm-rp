...
namespace Trinita.Core.Native
{
	public class Input
	{
		public static bool JustPressed(int padIndex, Control control) => Function.Call<bool>(Hash.IS_CONTROL_JUST_PRESSED, padIndex, control);
		public static bool JustReleased(int padIndex, Control control) => Function.Call<bool>(Hash.IS_CONTROL_JUST_RELEASED, padIndex, control);
		public static bool Pressed(int padIndex, Control control) => Function.Call<bool>(Hash.IS_CONTROL_PRESSED, padIndex, control);
		public static bool Released(int padIndex, Control control) => Function.Call<bool>(Hash.IS_CONTROL_RELEASED, padIndex, control);
	}
